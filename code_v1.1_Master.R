...
createKPIBox <- function(data, metric_name, box_color, output_metric ,icon ,divisor) {
  ...
  if(divisor==4) {
    metric_value <- max(metric_data$y, na.rm = TRUE)
  }
  
  # Convert the metric value to billions
  if(divisor==1)
    {
      display_value <- format(round(metric_value / 1e9, 2), big.mark = ",")
      unit <- "Billion euros"
    }
  if(divisor==2)
  {
    display_value <- format(round(metric_value / 1e6, 2), big.mark = ",")
    unit <- "Million euros"
  }
  
  if(divisor==3)
  {
    display_value <- format(round(metric_value / 1e3, 2), big.mark = ",")
    unit <- "Thousands "
  }
  
  if(divisor==4)
  {
    display_value <- format(round(metric_value / 1, 2), big.mark = ",")
    unit <- "Millions "
  }
          ...
          column(
            ...
            box(
              ...
              selectInput("country_mol", "Country:", 
                          choices = c("Germany", "France", "Italy", "Poland","Romania"))
            )
          ),
          column(
            width = 9,
      ...
      tabItem(
        ...
        fluidRow(
          ...
          column(
            ...
            box(
              width = NULL,
              highchartOutput("otcSalesChartMG", height = "500px")
        ...
        tabItem(
          ...
          fluidRow(
            box(
              ...
              collapsed  = TRUE,
              fluidRow(
                column(3, numericInput("person1_1", "Persona1 (%)", value = 90, min = 0, max = 100, step = 0.1)),
                column(3, numericInput("person2_1", "Persona2 (%)", value = 7.5, min = 0, max = 100, step = 0.1)),
                column(3, numericInput("person3_1", "Persona3 (%)", value = 2.5, min = 0, max = 100, step = 0.1)),
                column(3, numericInput("person4_1", "Persona4 (%)", value = 0, min = 0, max = 100, step = 0.1)),
                ...
                column(3, selectInput("Persona1_episodes_1", "Persona1 episodes", choices = seq(1, 30, by = 1), selected =4)),
                column(3, selectInput("Persona2_episodes_1", "Persona2 episodes", choices = seq(1, 30, by = 1), selected =2)),
                ...
                column(3, selectInput("Persona1_hcp_visit_1", "HCP visit each year", choices = seq(1, 5, by = 1), selected =1)),
                column(3, selectInput("Persona2_hcp_visit_1", "HCP visit each year", choices = seq(1, 5, by = 1), selected =1)),
                column(3, selectInput("Persona3_hcp_visit_1", "HCP visit each year", choices = seq(1, 5, by = 1), selected =1)),
                column(3, selectInput("Persona4_hcp_visit_1", "HCP visit each year", choices = seq(1, 5, by = 1), selected =1))
              )
            )
          )
        ),
          ...
          fluidRow(
            box(
              ...
              fluidRow(
                ...
                column(3, selectInput("Persona2_episode_duration_2", "Persona2 episode duration", choices = seq(1, 90, by = 1), selected =3)),
                ...
                column(3, selectInput("Persona2_Treatment_duration_2", "Persona2 treatement duration", choices = seq(1, 90, by = 1), selected =3)),
                ...
                column(3, selectInput("Persona2_episodes_2", "Persona2 episodes", choices = seq(1, 50, by = 1), selected =48)),
                ...
                column(3, selectInput("Persona1_hcp_visit_2", "HCP visit each year", choices = seq(1, 5, by = 1), selected =1)),
                column(3, selectInput("Persona2_hcp_visit_2", "HCP visit each year", choices = seq(1, 5, by = 1), selected =1)),
                column(3, selectInput("Persona3_hcp_visit_2", "HCP visit each year", choices = seq(1, 5, by = 1), selected =1)),
                column(3, selectInput("Persona4_hcp_visit_2", "HCP visit each year", choices = seq(1, 5, by = 1), selected =1))
              )
            )
          )
        ),
          ...
          fluidRow(
            box(
              ...
              fluidRow(
                ...
                column(3, selectInput("Persona1_hcp_visit_3", "HCP visit each year", choices = seq(1, 5, by = 1), selected =2)),
                column(3, selectInput("Persona2_hcp_visit_3", "HCP visit each year", choices = seq(1, 5, by = 1), selected =2)),
                column(3, selectInput("Persona3_hcp_visit_3", "HCP visit each year", choices = seq(1, 5, by = 1), selected =2)),
                column(3, selectInput("Persona4_hcp_visit_3", "HCP visit each year", choices = seq(1, 5, by = 1), selected =2))
              )
            )
          )
        ),
        tabItem(
          ...
          fluidRow(
            box(
              ...
              collapsed  = TRUE,
              fluidRow(
                column(3, numericInput("person1_4", "Persona1 (%)", value = 83, min = 0, max = 100, step = 0.1)),
                column(3, numericInput("person2_4", "Persona2 (%)", value = 17, min = 0, max = 100, step = 0.1)),
                ...
                column(3, selectInput("Persona2_episode_duration_4", "Persona2 episode duration", choices = seq(1, 90, by = 1), selected =14)),
                ...
                column(3, selectInput("Persona1_episodes_4", "Persona1 episodes", choices = seq(1, 30, by = 1), selected =10)),
                column(3, selectInput("Persona2_episodes_4", "Persona2 episodes", choices = seq(1, 30, by = 1), selected =18)),
                ...
                column(3, selectInput("Persona1_hcp_visit_4", "HCP visit each year", choices = seq(1, 5, by = 1), selected =1)),
                column(3, selectInput("Persona2_hcp_visit_4", "HCP visit each year", choices = seq(1, 5, by = 1), selected =1)),
                column(3, selectInput("Persona3_hcp_visit_4", "HCP visit each year", choices = seq(1, 5, by = 1), selected =1)),
                column(3, selectInput("Persona4_hcp_visit_4", "HCP visit each year", choices = seq(1, 5, by = 1), selected =1))
              )
            )
          )
        ),
        tabItem(
          ...
          fluidRow(
            box(
              ...
              collapsed  = TRUE,
              fluidRow(
                column(3, numericInput("person1_5", "Persona1 (%)", value = 100, min = 0, max = 100, step = 0.1)),
                column(3, numericInput("person2_5", "Persona2 (%)", value = 0, min = 0, max = 100, step = 0.1)),
                ...
                column(3, selectInput("Persona1_episode_duration_5", "Persona1 episode duration", choices = seq(1, 90, by = 1), selected =3)),
                column(3, selectInput("Persona2_episode_duration_5", "Persona2 episode duration", choices = seq(1, 90, by = 1), selected =0)),
                ...
                column(3, selectInput("Persona1_episodes_5", "Persona1 episodes", choices = seq(1, 30, by = 1), selected =3)),
                column(3, selectInput("Persona2_episodes_5", "Persona2 episodes", choices = seq(1, 30, by = 1), selected =0)),
                ...
                column(3, selectInput("Persona1_hcp_visit_5", "HCP visit each year", choices = seq(1, 5, by = 1), selected =1)),
                column(3, selectInput("Persona2_hcp_visit_5", "HCP visit each year", choices = seq(1, 5, by = 1), selected =1)),
                column(3, selectInput("Persona3_hcp_visit_5", "HCP visit each year", choices = seq(1, 5, by = 1), selected =1)),
                column(3, selectInput("Persona4_hcp_visit_5", "HCP visit each year", choices = seq(1, 5, by = 1), selected =1))
              )
            )
          )
        )
        ...
        fluidRow(
          ...
          box(title = "Title",
              ...
              fluidRow(column(width =10 ,
                   tags$h1(tags$b("Socioeconomic Estimates of Reverse Switching Ibuprofen"))),
            column(2,align = "center",
                   uiOutput("flag")
            )
            
            )),
          box(title = "Impact summary",
            width = 12,
            fluidRow(bs4ValueBoxOutput("patients_impacted", width = 4),
                     bs4ValueBoxOutput("Total_cost_KPI", width = 4) ,
                     bs4ValueBoxOutput("population_KPI", width = 4)),
            fluidRow(
              #bs4ValueBoxOutput("Total_cost_KPI", width = 3),
              bs4ValueBoxOutput("Total_clnic_visit_KPI", width = 3),
              bs4ValueBoxOutput("Total_RX_cost_KPI", width = 3),
              bs4ValueBoxOutput("Total_prod_loss_cost_KPI", width = 3),
              bs4ValueBoxOutput("Total_transport_cost", width = 3)


            )),
          box(
            title ="Facilty visit cost details" ,collapsed =TRUE,
            width =12,
            fluidRow(bs4ValueBoxOutput("HCP_clinic_visit_cost", width = 4),
                     bs4ValueBoxOutput("Non_pharma_facility_visit_cost", width = 4) ,
                     bs4ValueBoxOutput("ER_visit_cost", width = 4))
          ),
          box(
            width = 12,
            title ="Indication level details" ,collapsed =TRUE,
            fluidRow(
...
server <- function(input, output, session) {
  ...
  output$pivotChart <- renderHighchart({
    ...
    # Ensure "Others" is the last category
    data <- data %>%
      mutate(is_others = ifelse(Category == "Others", 1, 0)) %>%
      arrange(is_others, desc(percentage)) %>%
      select(-is_others)
  ...
  filteredBurdenData <- reactive({
    ...
    burden_summary <- burden_data %>%
      filter(grepl("ibuprofen", `Molecule Combination`, ignore.case = TRUE) & Country != "Romania" & Country == input$country3 & `Calendar Year` == 2023 & in_scope == "Y" & `Molecule Combination` != "DEXIBUPROFEN")
      #mutate(Total_MG = strength * SU)
    
    pivot_data <- pivotData2()
    pivot_data$total_mg <- sum(burden_summary$MG, na.rm = TRUE)
    pivot_data
  })
  ...
  filteredBurdenData3 <- reactive({
    req(input$country4)
    burden_summary <- burden_data %>%
      filter(grepl("ibuprofen", `Molecule Combination`, ignore.case = TRUE) & Country != "Romania" & Country == input$country4 & `Calendar Year` == 2023 & in_scope == "Y" & `Molecule Combination` != "DEXIBUPROFEN")
      #mutate(Total_MG = strength * SU)
  ...
  filteredBurdenData3_1 <- reactive({
    req(input$country5)
    burden_summary <- burden_data %>%
      filter(grepl("ibuprofen", `Molecule Combination`, ignore.case = TRUE) & Country != "Romania" & Country == input$country5 & `Calendar Year` == 2023 & in_scope == "Y" & `Molecule Combination` != "DEXIBUPROFEN")
      #mutate(Total_MG = strength * SU)
  ...
  RX_cost_per_epi <- reactive({
    req(input$country5)
    PPMG_raw_data <- pop_factor_3 %>%
      filter(Country != "Romania" & Country == input$country5) 
    
    pivot_data <- pivotData3_1()
    PPMG_value <- sum(PPMG_raw_data$rx_cost_per_epi, na.rm = TRUE)
    PPMG_value
    #PPMG_df <- data.frame(PPMG = PPMG_value) 
    #PPMG_df
  })
  
  Alt_otc_per_epi <- reactive({
    req(input$country5)
    PPMG_raw_data <- pop_factor_3 %>%
      filter(Country != "Romania" & Country == input$country5) 
    
    pivot_data <- pivotData3_1()
    PPMG_value <- sum(PPMG_raw_data$alternate_OTC_cost_per_episode, na.rm = TRUE)
    PPMG_value
    #PPMG_df <- data.frame(PPMG = PPMG_value) 
    #PPMG_df
  })
  ...
  non_clinic_visit_data <- reactive({
    req(input$country5)
    PPMG_raw_data <- pop_factor_oecd %>%
      filter(Country != "Romania" & Country == input$country5) 
    
    pivot_data <- pivotData3_1()
    PPMG_value <- sum(PPMG_raw_data$nonclinic_visit_cost, na.rm = TRUE)
    PPMG_value
    #PPMG_df <- data.frame(PPMG = PPMG_value) 
    #PPMG_df
  })
  ...
  data_parameters <- reactive({
    common_cold <- data.frame(
      ...
      Person1_HCP_visit = as.numeric(input$Persona1_hcp_visit_1),
      Person2_HCP_visit = as.numeric(input$Persona2_hcp_visit_1),
      Person3_HCP_visit = as.numeric(input$Persona3_hcp_visit_1),
      Person4_HCP_visit = as.numeric(input$Persona4_hcp_visit_1)
    ...
    Headache <- data.frame(
      ...
      Person1_HCP_visit = as.numeric(input$Persona1_hcp_visit_2),
      Person2_HCP_visit = as.numeric(input$Persona2_hcp_visit_2),
      Person3_HCP_visit = as.numeric(input$Persona3_hcp_visit_2),
      Person4_HCP_visit = as.numeric(input$Persona4_hcp_visit_2)
    )
    Dysmenorrhea <- data.frame(
      ...
      Person1_HCP_visit = as.numeric(input$Persona1_hcp_visit_3),
      Person2_HCP_visit = as.numeric(input$Persona2_hcp_visit_3),
      Person3_HCP_visit = as.numeric(input$Persona3_hcp_visit_3),
      Person4_HCP_visit = as.numeric(input$Persona4_hcp_visit_3)
    )
    ...
    body_pain <- data.frame(
      ...
      Person1_HCP_visit = as.numeric(input$Persona1_hcp_visit_4),
      Person2_HCP_visit = as.numeric(input$Persona2_hcp_visit_4),
      Person3_HCP_visit = as.numeric(input$Persona3_hcp_visit_4),
      Person4_HCP_visit = as.numeric(input$Persona4_hcp_visit_4)
    )
    ...
    dental_pain <- data.frame(
      ...
      Person1_HCP_visit = as.numeric(input$Persona1_hcp_visit_5),
      Person2_HCP_visit = as.numeric(input$Persona2_hcp_visit_5),
      Person3_HCP_visit = as.numeric(input$Persona3_hcp_visit_5),
      Person4_HCP_visit = as.numeric(input$Persona4_hcp_visit_5)
    )
    ...
    else if (i==2)
    {
      pop_factor_2 <- pop_factor_2 %>%
        filter(Country != "Romania" & Country == input$country5) %>%
        #mutate(Person1_epi = Person1_Episodes) %>%
        select(Category,Country,
               Share_of_population_taking_nothing, Share_of_population_taking_Rx_ibuprofen,
               Share_of_population_taking_Rx_other_OTC,Share_of_population_taking_Rx_others,
               Share_of_population_taking_non_medical_alternatives,Share_of_population_taking_alternatives)
    }
    result <- data %>%
    ...
    if (i==1)
    {
      result <- x %>%
        ...
        select(Category, MG_per_category, Factor_to_population,Person1_HCP_visit,Person2_HCP_visit,Person3_HCP_visit,Person4_HCP_visit) %>%
  ...
  pop_data <- 'www/pop.xlsx'
  
  pop_data <- read_excel(pop_data, sheet = "Sheet1")
  
  pop_data_18_above <- reactive({
    req(input$country5)
    PPMG_raw_data <- pop_data %>%
      filter(Country != "Romania" & Country == input$country5) 
    
    pivot_data <- pivotData3_1()
    PPMG_value <- max(PPMG_raw_data$Population, na.rm = TRUE)
    PPMG_value
    #PPMG_df <- data.frame(PPMG = PPMG_value) 
    #PPMG_df
  })
  ...
  otcSalesbuden_point_esitmete_2 <- reactive({
    ...
    result <- temp %>%
      mutate(Patients_seeking_HCP_Rx_ibuprofen = ceiling((Patients_per_category * Share_of_population_taking_Rx_ibuprofen) / 1)) %>%
      mutate(Patients_seeking_HCP_Rx_others = ceiling((Patients_per_category * Share_of_population_taking_Rx_others) / 1)) %>%
      mutate(Patients_seeking_HCP_Rx_other_OTC = ceiling((Patients_per_category * Share_of_population_taking_Rx_other_OTC) / 1)) %>%
      mutate(Patients_seeking_alternate_OTC = ceiling((Patients_per_category * Share_of_population_taking_alternatives) / 1)) %>%
      mutate(Patients_seeking_non_medical_alternative = ceiling((Patients_per_category * Share_of_population_taking_non_medical_alternatives) / 1)) %>%
      mutate(Patients_seeking_nothing = ceiling((Patients_per_category * Share_of_population_taking_nothing) / 1)) %>%
      mutate(clinic_visits_Patients_seeking_HCP_Rx_ibuprofen = ceiling((Patients_per_category * Share_of_population_taking_Rx_ibuprofen * Person1_HCP_visit) / 1)) %>%
      mutate(clinic_visits_Patients_seeking_HCP_Rx_others = ceiling((Patients_per_category * Share_of_population_taking_Rx_others * Person1_HCP_visit) / 1)) %>%
      mutate(clinic_visits_Patients_seeking_HCP_Rx_other_OTC = ceiling((Patients_per_category * Share_of_population_taking_Rx_other_OTC * Person1_HCP_visit) / 1)) %>%
      mutate(clinic_visits_Patients_seeking_alternate_OTC = ceiling((Patients_per_category * Share_of_population_taking_alternatives * 0) / 1)) %>%
      mutate(clinic_visits_Patients_seeking_non_medical_alternative = ceiling((Patients_per_category * Share_of_population_taking_non_medical_alternatives *  0) / 1)) %>%
      mutate(clinic_visits_Patients_seeking_nothing = ceiling((Patients_per_category * Share_of_population_taking_nothing * 0) / 1)) %>%
      mutate(Episodes_Patients_seeking_HCP_Rx_ibuprofen = ceiling((Patients_per_category * Share_of_population_taking_Rx_ibuprofen * Person1_epi) / 1)) %>%
      mutate(Episodes_Patients_seeking_HCP_Rx_others = ceiling((Patients_per_category * Share_of_population_taking_Rx_others * Person1_epi) / 1)) %>%
      mutate(Episodes_Patients_seeking_HCP_Rx_other_OTC = ceiling((Patients_per_category * Share_of_population_taking_Rx_other_OTC * Person1_epi) / 1)) %>%
      mutate(Episodes_Patients_seeking_alternate_OTC = ceiling((Patients_per_category * Share_of_population_taking_alternatives * Person1_epi) / 1)) %>%
      mutate(Episodes_Patients_seeking_non_medical_alternative = ceiling((Patients_per_category * Share_of_population_taking_non_medical_alternatives *  Person1_epi) / 1)) %>%
      mutate(Episodes_Patients_seeking_nothing = ceiling((Patients_per_category * Share_of_population_taking_nothing * Person1_epi) / 1)) %>%
        select(Category,Patients_per_category,
               Patients_seeking_HCP_Rx_ibuprofen, Patients_seeking_HCP_Rx_others, Patients_seeking_HCP_Rx_other_OTC,
               Patients_seeking_alternate_OTC, Patients_seeking_non_medical_alternative, Patients_seeking_nothing,
               clinic_visits_Patients_seeking_HCP_Rx_ibuprofen,clinic_visits_Patients_seeking_HCP_Rx_others,clinic_visits_Patients_seeking_HCP_Rx_other_OTC,
               clinic_visits_Patients_seeking_alternate_OTC,clinic_visits_Patients_seeking_non_medical_alternative,clinic_visits_Patients_seeking_nothing,
               Episodes_Patients_seeking_HCP_Rx_ibuprofen,Episodes_Patients_seeking_HCP_Rx_others,Episodes_Patients_seeking_HCP_Rx_other_OTC,
               Episodes_Patients_seeking_alternate_OTC,Episodes_Patients_seeking_non_medical_alternative,Episodes_Patients_seeking_nothing,Person1_HCP_visit
              )  
     
     result["PPMG"] <- PPMG_Data() 
     result["rx_cost_per_epi"] <- RX_cost_per_epi() 
     result["alternate_OTC_cost_per_episode"] <- Alt_otc_per_epi() 
     ...
     result["non_clinic_visit_cost"] <- non_clinic_visit_data()
     result["population_18_above"] <- pop_data_18_above()
     
     ## clninc visit cost 
     result <- result %>%
       mutate(Total_additional_clinic_visits = clinic_visits_Patients_seeking_HCP_Rx_ibuprofen+clinic_visits_Patients_seeking_HCP_Rx_others+clinic_visits_Patients_seeking_HCP_Rx_other_OTC) %>%
       mutate(Total_visits_to_non_medical_treatment_centers = Episodes_Patients_seeking_non_medical_alternative)%>%
       mutate(Total_additional_ER_visits_esimated = Total_additional_clinic_visits*ER_visit_rate)%>%
       mutate(Clinic_visit_cost_Rx_patients = Total_additional_clinic_visits*visit_cost)%>%
       mutate(ER_visit_cost_Rx_patients = Total_additional_ER_visits_esimated*ER_cost)%>%
       mutate(Cost_of_visits_to_non_medical_treatment_centers = Total_visits_to_non_medical_treatment_centers * non_clinic_visit_cost)%>%
       mutate(Facility_visit_cost = Clinic_visit_cost_Rx_patients+ER_visit_cost_Rx_patients+Cost_of_visits_to_non_medical_treatment_centers)
     
     
     ## clinic visit time cost 
     result <- result %>%
       mutate(clinic_visit_time_cost = Total_additional_clinic_visits * Prod_cost)%>%
       mutate(Non_pharma_treatment_time_cost = Total_visits_to_non_medical_treatment_centers * Prod_cost)%>%
       mutate(Total_time_cost = clinic_visit_time_cost + Non_pharma_treatment_time_cost)
     
     ## clinic visit transport cost 
     result <- result %>%
       mutate(clinic_visit_transport_cost = Total_additional_clinic_visits * BUS_cost)%>%
       mutate(Non_pharma_treatment_transport_cost = Total_visits_to_non_medical_treatment_centers * BUS_cost)%>%
       mutate(Total_trasport_cost = clinic_visit_transport_cost + Non_pharma_treatment_transport_cost)
     
     
     # ## medication costs 
      result <- result %>%
        mutate(cost_for_patients_taking_Rx_ibuprofen = Episodes_Patients_seeking_HCP_Rx_ibuprofen * PPMG *1200*3)%>%
        mutate(cost_for_patients_taking_Rx_others = Episodes_Patients_seeking_HCP_Rx_others * rx_cost_per_epi)%>%
        mutate(cost_for_patients_taking_Rx_other_OTC = Episodes_Patients_seeking_HCP_Rx_other_OTC * alternate_OTC_cost_per_episode)%>%
        mutate(cost_for_patients_taking_alternative_OTC = Episodes_Patients_seeking_alternate_OTC * alternate_OTC_cost_per_episode)%>%
        mutate(cost_for_patients_taking_alternative_non_medical = Episodes_Patients_seeking_non_medical_alternative * 0)%>%
        mutate(cost_for_patients_taking_alternative_nothing= Episodes_Patients_seeking_nothing * 0)%>%
        mutate(Total_medication_cost_patients = cost_for_patients_taking_Rx_ibuprofen+cost_for_patients_taking_Rx_others+cost_for_patients_taking_Rx_other_OTC+
                 cost_for_patients_taking_alternative_OTC+cost_for_patients_taking_alternative_non_medical+cost_for_patients_taking_alternative_nothing )
      
      # ## Total additional costs 
      result <- result %>%
        mutate(Total_cost = Clinic_visit_cost_Rx_patients+ER_visit_cost_Rx_patients+Cost_of_visits_to_non_medical_treatment_centers+
                 clinic_visit_time_cost+Non_pharma_treatment_time_cost+
                 clinic_visit_transport_cost+Non_pharma_treatment_transport_cost+
                 Total_medication_cost_patients)
  ...
  output$temp_table_22 <- renderDataTable({
    
    temp <- Updated_estimate()
  ...
  output$temp_table_2 <- renderDataTable({
    ...
    datatable(data, options = list(pageLength = 15, autoWidth = TRUE)) %>%
      formatRound(columns = setdiff(colnames(data), c("Category", "Country")), digits = 2)
  })
  
  
  output$temp_table_3 <- renderDataTable({
  ...
  output$population_KPI <- renderbs4ValueBox({
    waterfall_data <- Updated_estimate()
    
    createKPIBox(
      data = waterfall_data,
      metric_name = "population_18_above",
      box_color = "primary",
      output_metric = "Population above 18" ,
      icon = "person",
      divisor=4
    )
  })
  ...
  output$Total_clnic_visit_KPI <- renderbs4ValueBox({
    ...
    createKPIBox(
      data = waterfall_data,
      metric_name = "Facility_visit_cost",
      box_color = "primary",
      output_metric = "Total Facility visit Cost" ,
      icon = "hospital",
      divisor=1
    )
  })
  ...
  output$HCP_clinic_visit_cost <- renderbs4ValueBox({
    waterfall_data <- Updated_estimate()
    
    createKPIBox(
      data = waterfall_data,
      metric_name = "Clinic_visit_cost_Rx_patients",
      box_color = "primary",
      output_metric = "Total HCP clinic visit Cost" ,
      icon = "hospital",
      divisor=1
    )
  })
  
  output$Non_pharma_facility_visit_cost <- renderbs4ValueBox({
    waterfall_data <- Updated_estimate()
    
    createKPIBox(
      data = waterfall_data,
      metric_name = "Cost_of_visits_to_non_medical_treatment_centers",
      box_color = "primary",
      output_metric = "Total Non pharma clinic visit Cost" ,
      icon = "spa",
      divisor=1
    )
  })
  
  output$ER_visit_cost <- renderbs4ValueBox({
    waterfall_data <- Updated_estimate()
    
    createKPIBox(
      data = waterfall_data,
      metric_name = "ER_visit_cost_Rx_patients",
      box_color = "primary",
  ...
  output$Total_RX_cost_KPI <- renderbs4ValueBox({
    ...
    createKPIBox(
      data = waterfall_data,
      metric_name = "Total_medication_cost_patients",
      box_color = "primary",
      output_metric = "Total cost of medicines" ,
      icon = "pills",
      divisor=2
    )
  })
  ...
  output$Total_prod_loss_cost_KPI <- renderbs4ValueBox({
    ...
    createKPIBox(
      data = waterfall_data,
      metric_name = "Total_time_cost",
      box_color = "primary",
      output_metric = "Total Time loss" ,
      icon = "person-walking",
      divisor=2
    )
  })
  ...
  output$Total_transport_cost <- renderbs4ValueBox({
    ...
    createKPIBox(
      data = waterfall_data,
      metric_name = "Total_trasport_cost",
      box_color = "primary",
